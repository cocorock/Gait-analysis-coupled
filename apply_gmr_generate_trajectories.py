...
This script:
1. Loads trained TPGMM model from PKL file
...
Output:
- models/<folder_name>/gmr_trajectory_11dims.png
- models/<folder_name>/ankle_position_trajectories_xy.png
- models/<folder_name>/ankle_velocity_trajectories_vxvy.png
...
if __name__ == "__main__":
    ...
    # Configuration
    model_path = "train_tpgmm_model/trained_model.pkl"  # Update this path as needed
    
    # Check if model file exists
    if not os.path.exists(model_path):
        print(f"❌ Error: Model file not found: {model_path}")
        print("\nPlease either:")
        print("  1. Update the 'model_path' variable with the correct path")
        print("  2. Run 'train_tpgmm_model.py' first to train a model")
        sys.exit(1)
    
    # Run GMR trajectory generation
    mu_gen, sigma_gen = main(model_path)
