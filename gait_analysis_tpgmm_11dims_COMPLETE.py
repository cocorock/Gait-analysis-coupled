...
def plot_position_trajectories_xy(trajectories_fr1, mu_generated, sigma_generated):
    ...
    plt.tight_layout()
    plt.savefig('ankle_position_trajectories_xy.png', dpi=150, bbox_inches='tight')
    print("\n✓ Saved: ankle_position_trajectories_xy.png")
    plt.show()
...
def plot_velocity_trajectories_vxvy(trajectories_fr1, mu_generated, sigma_generated):
    ...
    plt.tight_layout()
    plt.savefig('ankle_velocity_trajectories_vxvy.png', dpi=150, bbox_inches='tight')
    print("\n✓ Saved: ankle_velocity_trajectories_vxvy.png")
    plt.show()
...
def plot_gaussian_components_position(best_model, trajectories_fr1):
    ...
    plt.tight_layout()
    plt.savefig('gaussian_components_position.png', dpi=150, bbox_inches='tight')
    print(f"\n✓ Saved: gaussian_components_position.png")
...
def plot_gaussian_components_velocity(best_model, trajectories_fr1):
    ...
    plt.tight_layout()
    plt.savefig('gaussian_components_velocity.png', dpi=150, bbox_inches='tight')
    print(f"\n✓ Saved: gaussian_components_velocity.png")
    print(f"✓ Displayed {K} Gaussian components with their means (dots) and covariances (ellipses)")
    plt.show()
...
def main(data_path, subsample_factor=10, n_jobs=-1):
    ...
    print("  1. gmr_trajectory_11dims.png - Time series plots")
    print("  2. bic_model_selection_11dims.png - BIC scores")
    print("  3. ankle_position_trajectories_xy.png - X-Y position trajectories")
    print("  4. ankle_velocity_trajectories_vxvy.png - Vx-Vy velocity trajectories")
    print("  5. gaussian_components_position.png - GMM components (positions)")
    print("  6. gaussian_components_velocity.png - GMM components (velocities)")
    print("="*70)
